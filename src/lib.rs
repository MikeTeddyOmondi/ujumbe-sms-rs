...
// #[cfg(test)]
// mod tests {
//     // TESTS Using `mockito@0.31`
//     use mockito::{mock, server_url};
//     use crate::{MessageRequest, UjumbeSmsClient, UjumbeSmsConfig};
//     #[tokio::test]
//     async fn test_send_single_message() {
//         // Setup mock server
//         let _m = mock("POST", "/api/messaging")
//             .with_status(200)
//             .with_header("content-type", "application/json")
//             .with_body(
//                 r#"{
...
//         // Test sending a single message
//         let result = client
//             .send_single_message("07123456789", "Test message", "TESTSENDER")
//             .await;
//         assert!(result.is_ok());
//         let response = result.unwrap();
//         assert_eq!(response.status.code, "1008");
//         assert_eq!(response.status.r#type, "success");
//         assert_eq!(response.meta.recipients, 1);
//         assert_eq!(response.meta.credits_deducted, 1);
//         assert_eq!(response.meta.available_credits, "6608");
//     }
//     #[tokio::test]
...
//         let mut request = MessageRequest::new();
//         request.add_message_bag(
//             "07123456789".to_string(),
//             "First test message".to_string(),
//             "TESTSENDER".to_string(),
//         );
//         request.add_message_bag(
//             "07123456790,07123456791".to_string(),
//             "Second test message".to_string(),
//             "TESTSENDER".to_string(),
//         );
//         // Test sending multiple messages
...
//         assert_eq!(response.status.code, "1008");
//         assert_eq!(response.status.r#type, "success");
//         assert_eq!(response.meta.recipients, 3);
//         assert_eq!(response.meta.credits_deducted, 3);
//         assert_eq!(response.meta.available_credits, "6605");
//     }
//     #[tokio::test]
